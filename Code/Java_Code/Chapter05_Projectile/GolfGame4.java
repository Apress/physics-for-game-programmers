...
public class GolfGame4 extends JFrame implements ActionListener
{
  ...
  public GolfGame4() {
    ...
    //  Create a SpinProjectile object representing
    //  the golf ball.
    golfball = 
    ...
    windVxTextField = new JTextField("10.0",6);
    ...
    omegaTextField = new JTextField("300.0",6);
    radiusTextField    = new JTextField("0.02135",6);
    ...
    omegaLabel = new JLabel("Angular velocity, rad/s");
    radiusLabel = new JLabel("Sphere radius, m");
    ...
    gbc = new GridBagConstraints(col, row, numCol, numRow,
                 0.0, 0.0, GridBagConstraints.EAST,
                 GridBagConstraints.NONE, insets, 0, 0);
    gridBagLayout1.setConstraints(omegaLabel, gbc);

    col = 5;
    gbc = new GridBagConstraints(col, row, numCol, numRow,
                 0.0, 0.0, GridBagConstraints.WEST,
                 GridBagConstraints.NONE, insets, 0, 0);
    gridBagLayout1.setConstraints(omegaTextField, gbc);
    ...
    westPanel.add(omegaLabel);
    westPanel.add(omegaTextField);
