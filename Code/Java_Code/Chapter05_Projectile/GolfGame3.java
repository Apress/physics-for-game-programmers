...
public class GolfGame3 extends JFrame implements ActionListener
{
  ...
  public GolfGame3() {
    ...
    //  Create a WindProjectile object representing
    //  the golf ball.
    golfball = 
    ...
    windVxLabel = new JLabel("Wind x-velocity, m/s");
    windVyLabel = new JLabel("Wind y-velocity, m/s");
